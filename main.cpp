...
int main() {
    ...
    Game game(3);  // Initialize the game with default board size
    ...
    while (!glfwWindowShouldClose(mainWindow)) {
        ...
        guiManager.renderGUI(currentPlayer, selected_radio1, selected_radio2, newGameTriggered, dummyBoardSize, newBoardSize);
